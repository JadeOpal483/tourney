...
- `tornelo-display-exact.html`
- `tornelo-player-card-exact.html`
- `tornelo-player-qr-exact.html`
...
Open:
- `https://YOUR-RENDER-URL/tornelo-display-exact.html`
- `https://YOUR-RENDER-URL/tornelo-player-card-exact.html`
- `https://YOUR-RENDER-URL/tornelo-player-qr-exact.html`
